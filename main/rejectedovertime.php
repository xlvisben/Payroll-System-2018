...
if ($period=="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where status='2'   ");
}elseif ($period!="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where  status='2' and period='$period'");
}
?>
