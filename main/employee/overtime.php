...
if ($period=="all") {
    $seresult=mysqli_query($GLOBALS['connect'],"SELECT * FROM empvsovertime where empid='$user' ");
}elseif ($period!="all") {
    $seresult=mysqli_query($GLOBALS['connect'],"SELECT * FROM empvsovertime where empid='$user' and period='$period' order by id desc ");
}
?>
