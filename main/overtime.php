...
if ($period=="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where status='0'");
}elseif ($period!="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where status='0' and period='$period'");
}
?>
