...
if ($period=="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where status='1'");
}elseif ($period!="all") {
    $seresult=mysqli_query($GLOBALS['connect'], ("SELECT * FROM empvsovertime where status='1' and period='$period'");
}
?>
