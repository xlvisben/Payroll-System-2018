...
$result=mysqli_query($GLOBALS['connect'],"SELECT * FROM payroll_tbl WHERE payrollrun='$period' and id='$id'");
while($row=mysqli_fetch_array($result)){
    $sid=$row['staffid'];
    $s=mysqli_fetch_array(mysqli_query($GLOBALS['connect'],"SELECT st.type_name as stype, s.national_id as natid ,s.accountno as bankacc ,s.bankcode as bcode FROM staff s  inner join stafftype st on st.id=s.staff_type  where s.id='$sid'"));
    $bcode=$s['bcode'];
